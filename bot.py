...
DL_BUTTONS=[
    [
        InlineKeyboardButton('Suv belgisiz', callback_data='nowm'),
        InlineKeyboardButton('Suv belgisi bilan', callback_data='wm'),
    ],
    [InlineKeyboardButton('faqat audio', callback_data='audio')],
]
...
async def _tiktok(bot, update):
  ...
  if not 'tiktok.com' in resp.url:
    return
  await update.reply('Quyidagi variantlarni tanlang', True, reply_markup=InlineKeyboardMarkup(DL_BUTTONS))
